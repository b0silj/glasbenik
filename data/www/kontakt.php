    ...
    <main class="flex-grow-1">
     ...
     <section id="kontakt" class="container contact-wrap">
        <!--<form class="contact-form">
          ...
          <input id="email" class="form-control" type="email" placeholder="Vpišite email">
          ...
          <textarea id="message" class="form-control" rows="4" placeholder="Vaše vprašanje"></textarea>
        </br>
